   /* JAVASCRIPT CODE GOES HERE */
    Plotly.d3.csv('data/Scrap_Count_Real.csv', function(err, rows){
...
var allMachineNames = unpack(rows, 'Station'),
    ...
    allCount = unpack(rows, 'Scrap_Count'),
    listofMachines = [],
    currentMachine,
    currentCount = [],
    currentMonth = [];
...
function setBubblePlot(chosenMachine) {
  ...
  displayModeBar: false, //this one does work
    ...
    Plotly.newPlot('plotdiv2', data, layout, options);
};
  
var innerContainer = document.querySelector('[data-num="0"'),
    plotEl = innerContainer.querySelector('.plot'),
    machineSelector = innerContainer.querySelector('#machinedata2');
